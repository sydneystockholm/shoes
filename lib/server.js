...
Server.prototype.create = function () {
    ...
    //Ignore socket hang up errors introduced in v0.8.20 (c9dcf57)
    app.use(function (request, response, next) {
        ['send', 'redirect'].forEach(function (method) {
            var fn = response[method];
    ...
    app.use(function (request, response, next) {
        response.renderTemplate = function (file, locals, callback) {
            locals = locals || {};
            file += '.html';
            ...
            try {
                callback(null, env.render(file, locals));
            } catch (err) {
        ...
        response.render = function (file, locals) {
            response.renderTemplate(file, locals, function (err, template) {
